    ...
    <>
      <section className="relative text-center py-20 sm:py-32">
        <div aria-hidden="true" className="absolute top-0 left-1/2 -z-10 -translate-x-1/2">
          <div className="h-[40rem] w-[70rem] rounded-full bg-gradient-to-tr from-sky-400 to-blue-700 blur-3xl opacity-25" />
        </div>
      ...
      <section id="companies" className="py-12">
        <h2 className="text 3-xl font-bold text-center mb-8">Companies</h2>
        {companies.length > 0 ? (
